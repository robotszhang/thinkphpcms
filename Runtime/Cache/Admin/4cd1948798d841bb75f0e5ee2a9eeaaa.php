...
</script>                    <small class="form-text text-muted"></small>                </div>                <div class="form-group">                    <label>浏览量</label>                    <div class="form-inline">                        <input type="text" class="form-control" name="click" placeholder="浏览量" style="width:400px;" value="<?php echo ($page["click"]); ?>" />                    </div>                    <small class="form-text text-muted"></small>                </div>                <div class="form-group">                    <label>文章详情</label>                    <!--
必填参数：
inputname
inputvalue
可选参数：
