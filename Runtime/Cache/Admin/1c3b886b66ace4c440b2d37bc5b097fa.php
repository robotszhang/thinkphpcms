...
<div class="g-page-in">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>手机</label>
            <div class="form-inline">
                <input type="text" class="form-control" name="phone" placeholder="手机" style="width:400px;" value="" />
            </div>
        ...
        <div class="form-group">
            <label>留言内容</label>
            <div class="form-inline">
                <textarea class="form-control" name="body" style="width: 400px;"></textarea>
            </div>
            <small class="form-text text-muted"></small>
        </div>
        <div class="form-group">
...
<div class="input-group" style="width: 200px;">
    <input type="text" class="form-control form-control-sm" name="created_at" placeholder="<?php echo ($placeholder); ?>" value="" >
...
<script>
    ...
    $("input[name='created_at']").flatpickr({
        ...
        <div class="form-group">
            <label>留言回复</label>
            <div class="form-inline">
                <textarea class="form-control" name="response" style="width: 400px;"></textarea>
            </div>
            <small class="form-text text-muted"></small>
        </div>
        <div class="form-group">
...
<div class="input-group" style="width: 200px;">
    <input type="text" class="form-control form-control-sm" name="response_at" placeholder="<?php echo ($placeholder); ?>" value="" >
    <div class="input-group-append">
        <span class="input-group-text">
            <i class="fa fa-calendar" aria-hidden="true"></i>
        </span>
