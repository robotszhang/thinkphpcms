 ...
 */
 ...
 change(1);
 change(2);
 /*$('#s_city').onclick = function (){alert(1);change(1);};

 $(opt0[2]).onclick = function (){change(2);};*/
 }


/*function _init_area(sArr){
	if(!sArr){
		sArr = ["s_province","s_city","s_county"];
	}else{
		sArr =  ["s_province","s_city","s_county"].concat(sArr);
		console.log(sArr);
	}
